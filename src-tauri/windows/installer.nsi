; Derived from Tauri tauri-bundler 2.9.4; review against Tauri updates before changing the bundler version.
Unicode true
...
Function PageReinstall
  ...
  ; Automatically install a newer version in place. This preserves app data and shortcuts.
  ; Reinstalling or downgrading still presents the normal maintenance choices.
  ${If} $R0 = 1
    StrCpy $UpdateMode 1
