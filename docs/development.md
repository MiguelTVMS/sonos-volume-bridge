...
production frontend build. Test at a 600-pixel width and both default and minimum
window heights, including dark mode, keyboard focus, and increased contrast.
